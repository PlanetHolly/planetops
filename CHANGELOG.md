...
## 2026-07-27 — Stage 1 / Stage 2 are now actually separate: the Board's unscheduled pool is the exact COMPLEMENT of the Queue — PR OPEN on `jean/board-stage-gate`
