...
## 2026-07-24 — Full-outsource imprints leave the QUEUE: Printavo's per-imprint **Type of Work** now names the in-house leg — PR OPEN on `jean/queue-vendor-only`
...
- ⚠ Data gap this surfaced, for Jean not for the code: `27285` (Kabouter Creative), `27314` and `27335` (Anythink Nature Library A/B) are single-imprint Digital Bandana orders with no in-house leg in Printavo, while their siblings `27232`/`27249`/`27325`/`27495`/`27551` all carry a `-2` In-House Production imprint. If those three do need in-house packaging, the imprint is missing **in Printavo** — after this change they will not appear in the Queue at all (they stay visible in Arrivals under the new vendor-only chip).
