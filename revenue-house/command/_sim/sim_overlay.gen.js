...
const SIM_OVERLAY = {
  ...
  "427399": {
    "id": "427399",
    "phase": "Quote & Chase",
    "description": "The PM revised the quote after the customer asked for an update, then dropped it here to send itself. Choosing this over 📮 Quote Revised - Drafted, Ready To Send (548987) is deliberate: this lane goes out on its own and re-enters the chase, which is what you want on a T3 (under $1,000), where hand-drafting the revision costs more than the order is worth. 🔴 never delete (chase start-trigger).",
    "flavor": "customer",
  ...
  "548873": {
    ...
    "scriptCodes": ["^ot_sample_shipped", "^ot_sample_arrival_checkin", "^ot_sample_arrival_checkin_plus2", "^ot_sample_arrival_checkin_plus5"],
  ...
  "548877": {
    "id": "548877",
    "phase": "Quote & Chase",
    "description": "The PM sent the quote by hand instead of letting the system chase it, and is running the follow-ups off their own Streak tasks. The difference from Follow-Up Pre-Quote: there, no quote has gone out yet. Here one has, it just was not sent by the system.",
    "flavor": "nudge",
    "automation": "No customer email. PM nudge only, mimicking Follow-Up Pre-Quote (Streak Task): if there is no movement for 14 days, the owner gets nudged in the 🐌 Stale chat. 🔴 A customer reply does NOT move this one. Every other quote status routes a reply to 💬🔔 Quote Approval — Customer Replied (549571), but this status already has a Streak task attached and moving the order would strand it. The PM handles the reply on the task they already have.",
    "scriptCodes": [],
    "nudge": {
  ...
  "548987": {
    "id": "548987",
    "phase": "Quote & Chase",
    "description": "A revised quote, drafted for the PM to send, after the customer replied asking for an update. The twin of 🚀Quote Revised - Auto Sent (427399): use this one when the order is worth a personal read before it goes out, and the auto lane when it is not.",
    "flavor": "nudge",
